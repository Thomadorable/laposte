<section class="block01 h100%">
    <div class="maxWidth">
        <div class="txtArea">
            <h2 class="typo1">
                La première box qui récompense vos actions envers la planète. 🌳
            </h2>
            <p class="typo2">
...
<section class="block02">
    <div class="maxWidth typo2">
        ...
        <div class="col3">
            <img src="<?= base ?>images/mailbox.gif" alt="">
            <p>Je reçois ma <span class="bold">boîte personnelle</span>, identifiable grâce à son flashcode unique. Elle fera la <span class="bold">navette</span> entre Paaper, et moi pendant toute la durée de mon abonnement. </p>
        </div><div class="col3">
            <img src="<?= base ?>images/mailbox.gif" alt="">
